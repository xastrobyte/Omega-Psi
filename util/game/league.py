...
def getMatchStats(discordEmbed, matchDict, accountId):
    ...
    for participant in matchDict["participants"]:
        ...
        participantInfo = "{} - {} - {} - {}".format(
            ...
            participant["highestAchievedSeasonTier"].capitalize().ljust(tierLength),       # Tier
    ...
    # Setup field value
    fieldValue = (
        "__Name - Tier - KDA (Ratio) - Total Damage__\n" +
        "**Blue Team**\n{}\n" +
        "**Red Team**\n{}\n"
    ).format(
        "```diff\n" + blueTeamText + "```",
