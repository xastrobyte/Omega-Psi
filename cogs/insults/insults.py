...
class Insults(Cog, name = "insults"):
    ...
    async def approve(self, ctx, index, *, is_insult = True):
        ...
        ----------
            ctx : context
                The context of where to send the confirmation message to whoever
                reacted with the approve reaction
            index : int
                The index of the pending insult or compliment to approve
            is_insult : boolean
                Whether or not to approve an insult or compliment at the specified index.
                Defaults to True
        """
    ...
    async def deny(self, ctx, index, *, is_insult = True):
        ...
        ----------
            ...
            index : int
                The index of the pending insult or compliment to deny
            is_insult : boolean
                Whether or not to deny an insult at the specified index.
                Defaults to True
        """
