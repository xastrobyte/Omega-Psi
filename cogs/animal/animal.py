...
async def animal_command(ctx, animal, *, baby=False, fact=False):
    """Runs the animal API to get a random picture or fact of the specified animal

    :param ctx: The context of where the message was sent
    :param animal: The type of animal
    :param baby: Whether or not to get a baby type of the specified animal
    :param fact: Whether or not to get a fact about the specified animal
    """
    ...
    if not fact:
        result = await loop.run_in_executor(
            None, get,
            ANIMAL_API.format(animal) if not baby else BABY_ANIMAL_API.format(animal)
        )
        result = result.json()
    ...
    # Check if getting an animal fact
        ...
        if animal in ["dog", "cat"]:
            response = await loop.run_in_executor(
                None, get, DOG_CAT_FACT_API.format(animal)
            )
...
class Animal(Cog, name="animal"):
    ...
    async def dog(self, ctx):
        """Retrieves a picture of a random dog from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        if not ctx.invoked_subcommand:
            await animal_command(ctx, "dog")
    ...
    async def dog_baby(self, ctx):
        """Retrieves a baby picture of a random dog from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        await animal_command(ctx, "dog", baby=True)
    ...
    async def dog_fact(self, ctx):
        """Retrieves a random fact about dogs from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        await animal_command(ctx, "dog", fact=True)
    ...
    async def cat(self, ctx):
        """Retrieves a picture of a random cat from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        if not ctx.invoked_subcommand:
            await animal_command(ctx, "cat")
    ...
    async def cat_baby(self, ctx):
        """Retrieves a baby picture of a random cat from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        await animal_command(ctx, "cat", baby=True)
    ...
    async def cat_fact(self, ctx):
        """Retrieves a random fact about cats from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        await animal_command(ctx, "cat", fact=True)
    ...
    async def fox(self, ctx):
        """Retrieves a picture of a random fox from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        if not ctx.invoked_subcommand:
            await animal_command(ctx, "fox")
    ...
    async def fox_baby(self, ctx):
        """Retrieves a baby picture of a random fox from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        await animal_command(ctx, "fox", baby=True)
    ...
    async def penguin(self, ctx):
        """Retrieves a picture of a random penguin from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        if not ctx.invoked_subcommand:
            await animal_command(ctx, "penguin")
    ...
    async def penguin_baby(self, ctx):
        """Retrieves a baby picture of a random penguin from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        await animal_command(ctx, "penguin", baby=True)
    ...
    async def elephant(self, ctx):
        """Retrieves a picture of a random elephant from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        if not ctx.invoked_subcommand:
            await animal_command(ctx, "elephant")
    ...
    async def elephant_baby(self, ctx):
        """Retrieves a baby picture of a random elephant from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        await animal_command(ctx, "elephant", baby=True)
    ...
    async def sloth(self, ctx):
        """Retrieves a picture of a random sloth from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        if not ctx.invoked_subcommand:
            await animal_command(ctx, "sloth")
    ...
    async def sloth_baby(self, ctx):
        """Retrieves a baby picture of a random sloth from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        await animal_command(ctx, "sloth", baby=True)
    ...
    async def rabbit(self, ctx):
        """Retrieves a picture of a random rabbit from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        if not ctx.invoked_subcommand:
            await animal_command(ctx, "rabbit")
    ...
    async def rabbit_baby(self, ctx):
        """Retrieves a baby picture of a random rabbit from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        await animal_command(ctx, "rabbit", baby=True)
    ...
    async def hedgehog(self, ctx):
        """Retrieves a picture of a random hedgehog from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        if not ctx.invoked_subcommand:
            await animal_command(ctx, "hedgehog")
    ...
    async def hedgehog_baby(self, ctx):
        """Retrieves a baby picture of a random hedgehog from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        await animal_command(ctx, "hedgehog", baby=True)
    ...
    async def bat(self, ctx):
        """Retrieves a picture of a random bat from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        if not ctx.invoked_subcommand:
            await animal_command(ctx, "bat")
    ...
    async def bat_baby(self, ctx):
        """Retrieves a baby picture of a random bat from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        await animal_command(ctx, "bat", baby=True)
    ...
    async def squirrel(self, ctx):
        """Retrieves a picture of a random squirrel from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        if not ctx.invoked_subcommand:
            await animal_command(ctx, "squirrel")
    ...
    async def squirrel_baby(self, ctx):
        """Retrieves a baby picture of a random squirrel from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        await animal_command(ctx, "squirrel", baby=True)
    ...
    async def hamster(self, ctx):
        """Retrieves a picture of a random hamster from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        if not ctx.invoked_subcommand:
            await animal_command(ctx, "hamster")
    ...
    async def hamster_baby(self, ctx):
        """Retrieves a baby picture of a random hamster from the
        internet to show the user.

        :param ctx: The context of where the message was sent
        """
        await animal_command(ctx, "hamster", baby=True)
